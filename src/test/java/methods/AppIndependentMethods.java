...
public class AppIndependentMethods extends DriverScript {
	 ...
	 * Purpose : to 	capture date & time in required
	 * format Author :	
	 *
	 ****************************************/
	...
	****************************************/
	public String captureScreenShot(WebDriver oDriver) {
		...
		try {
			strDestination = strScrnShotLocation + "\\screenShot_" + appInd.getDateTime("ddMMYY_hhmmss") + ".png";
	...
	public boolean isElementPresent(WebDriver oDriver, By objBy)
	{
		...
		try {
			...
			if(oEles.size()>0) {
				...
				reports.writeResult(oDriver,"Fail", "The element '"+String.valueOf(objBy)+"' doesnot exist",test,false);
				return false;
			}
		}catch(Exception e)
		{
	...
	public WebDriver launchBrowser(String browser)
	{
		...
		try {
			...
			{
				case "ch":
					System.setProperty("webdriver.chrome.driver", "C:\\SG_Maven_Framework\\SG_MVN_Projects\\Library\\drivers\\chromedriver.exe");			
					oDriver = new ChromeDriver();
					break;
				case "ff":
					System.setProperty("webdriver.gecko.driver", "C:\\SG_Maven_Framework\\SG_MVN_Projects\\Library\\drivers\\geckodriver.exe");			
					oDriver = new FirefoxDriver();
					break;
				case "ie":
					System.setProperty("webdriver.ie.driver", "C:\\SG_Maven_Framework\\SG_MVN_Projects\\Library\\drivers\\IEDriverServer.exe");			
